...
const data = require("../../files/multibar_data.json");
...
dreams.tests("INT: multibarChart -", function(t) {
  ...
  t.test("title: render title by default", function(assert) {
    nightmare
      ...
      .then(function(result) {
        assert.equal(result, "Test multibar chart");
        assert.end();
      })
      .catch(function(msg) { dreams.error(msg, assert, nightmare); });
  });
  ...
  // Dimensions
  t.skip("dimensions: margins can be defined", function(assert) {
    nightmare
      .chart(options)
      .config("default")
      .evaluate(function(json) {
  ...
  t.skip("dimensions: default to container dimensions", function(assert) {
    nightmare
      .chart(options)
      .config("default")
      .render(json)
  ...
  t.skip("dimensions: width and height can be defined", function(assert) {
    nightmare
      .chart(options)
      .config("default")
      .evaluate(function(json) {
  ...
  t.test("tooltips: setting tooltips to false prevents tooltip display", function(assert) {
    nightmare
      ...
      .evaluate(function() {
        ...
        chart.multibar.dispatch.call("elementMouseover", this, {
          pointIndex: 0,
          point: null,
          seriesIndex: 0,
          series: null,
  ...
  t.test("tooltips: dispatching elementMouseout on chart destroys tooltip", function(assert) {
    nightmare
      ...
      .evaluate(function() {
        ...
        chart.multibar.dispatch.call("elementMouseout", this);
        return document.querySelector(".tooltip");
      })
      .then(function(result) {
        assert.equal(result, null);
  ...
  t.test("texture fill: texture fill elements are not rendered by default", function(assert) {
    nightmare
      ...
      .render(json)
      .evaluate(function() {
        return document.querySelector(".sc-series-0 .sc-texture");
      })
      .then(function(result) {
        assert.equal(result, null);
        assert.end();
  ...
  t.test("texture fill: setting texture fill to true renders texture elements", function(assert) {
    nightmare
      ...
      .evaluate(function(json) {
        ...
        render(json);
        return getElement(".sc-series-0 .sc-texture");
      }, json)
      .then(function(result) {
