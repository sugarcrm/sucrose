...
const data = require("../../files/bubble_data.json");
...
dreams.tests("INT: bubbleChart -", function(t) {
  ...
  t.test("title: render title by default", function(assert) {
    nightmare
      ...
      .then(function(result) {
        assert.equal(result, "Test bubble chart");
        assert.end();
      })
      .catch(function(msg) { dreams.error(msg, assert, nightmare); });
  });
  ...
  t.test("color: palette is category20 by default", function(assert) {
    nightmare
      ...
      .render(json)
      .evaluate(function() {
        var result = getElement(".sc-scatter .sc-series-0");
        return {
  ...
  t.skip("color: palette controlled by color attribute of series Data", function(assert) {
    nightmare
      .chart(options)
      .config("data")
      .evaluate(function(json) {
        ...
        d.data[0].color = "#000";
        render(d);
        result = getElement(".sc-scatter .sc-series-0");
        return {
          fill: result.getAttribute("fill"),
          class: result.getAttribute("class"),
        };
  ...
  t.skip("tooltips: define tooltip content", function(assert) {
    nightmare
      ...
      .evaluate(function() {
        ...
        chart.bubble.dispatch.call("elementMouseover", this, {
          id: "asfd",
          key: "test",
          value: 100,
          count: 1,
  ...
  //     render(data);
  //     chart.bubble.dispatch.call("elementClick", this, {
  //           id: "asfd",
  //           key: "test",
  //           value: 100,
  //           count: 1,
