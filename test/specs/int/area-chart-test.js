...
const data = require("../../files/area_data.json");
...
dreams.tests("INT: areaChart -", function(t) {
  ...
  t.test("title: render title by default", function(assert) {
    nightmare
      ...
      .then(function(result) {
        assert.equal(result, "Test area chart");
        assert.end();
      })
      .catch(function(msg) { dreams.error(msg, assert, nightmare); });
  });
  ...
  t.test("color: palette is category20 by default", function(assert) {
    nightmare
      ...
      .render(json)
      .evaluate(function() {
        var result = getElement(".sc-area .sc-series-0");
        return {
  ...
  t.test("color: palette controlled by color attribute of series Data", function(assert) {
    nightmare
      ...
      .evaluate(function(json) {
        ...
        d.data[0].color = "#000";
        render(d);
        result = getElement(".sc-area .sc-series-0");
        return {
          fill: result.getAttribute("fill"),
          class: result.getAttribute("class"),
        };
  ...
  t.skip("tooltips: dispatching elementMouseover on chart triggers tooltip", function(assert) {
    nightmare
      ...
      .evaluate(function() {
        ...
        chart.area.dispatch.call("elementMouseover", this, {
          id: "asfd",
          key: "test",
          value: 100,
          count: 1,
  ...
  t.skip("tooltips: dispatching elementMouseout on chart destroys tooltip", function(assert) {
    nightmare
      ...
      .evaluate(function() {
        ...
        chart.area.dispatch.call("elementMouseout", this);
        return document.querySelector(".tooltip");
      })
      .then(function(result) {
        assert.equal(result, null);
  ...
  //     render(data);
  //     chart.area.dispatch.call("elementClick", this, {
  //           id: "asfd",
  //           key: "test",
  //           value: 100,
  //           count: 1,
