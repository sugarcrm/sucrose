;// https://d3js.org Version 4.13.0. Copyright 2021 Mike Bostock.
...
function graticule() {
  ...
  function lines() {
    return sequence(ceil(X0 / DX) * DX, X1, DX).map(X)
        ...
        .concat(sequence(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs(x % DX) > epsilon$1; }).map(x))
        .concat(sequence(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs(y % DY) > epsilon$1; }).map(y));
  }
...
var tau$2 = 2 * pi$2;
var epsilon$2 = 1e-6;
var tauEpsilon = tau$2 - epsilon$2;
...
function stack() {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant$7(slice$5.call(_)), stack) : keys;
  };
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none$2 : typeof _ === "function" ? _ : constant$7(slice$5.call(_)), stack) : order;
  };
